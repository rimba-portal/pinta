...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create(config('pinta.tables.activity_assignments'), function (Blueprint $t): void {
            $t->id();
        ...
        Schema::create(config('pinta.tables.workflow_links'), function (Blueprint $t): void {
            $t->id();
        ...
        Schema::create(config('pinta.tables.workflow_outputs'), function (Blueprint $t): void {
            $t->id();
